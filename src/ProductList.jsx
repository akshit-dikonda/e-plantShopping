    ...
    const plantsArray = [
        ...
        },
        {
            ...
            plants: [
                ...
                {
                    name: "Citronella",
                    image: "https://cdn.pixabay.com/photo/2018/07/05/14/47/grass-3517501_1280.jpg",
                    description: "Known for its mosquito-repelling properties.",
                    cost: "$16"
                },
                {
                    name: "Catnip",
        ...
        },
        {
            ...
            plants: [
                ...
                },
                {
                    ...
                    description: "Traditionally used to support wellness.",
                    cost: "$16"
                },
                {
                    name: "Peppermint",
                ...
                },
                {
                    ...
                    description: "Popular herb commonly used in calming teas.",
                    cost: "$15"
                },
                {
                    name: "Calendula",
                    image: "https://cdn.pixabay.com/photo/2019/07/15/18/28/flowers-4340127_1280.jpg",
                    description: "Bright flowering plant traditionally used for skin care.",
                    cost: "$12"
                }
            ]
        },
        {
            ...
            plants: [
                ...
                },
                {
                    name: "Snake Plant",
                    image: "https://cdn.pixabay.com/photo/2021/01/22/06/04/snake-plant-5939187_1280.jpg",
                    description: "Needs infrequent watering and is highly resilient.",
                    cost: "$15"
                },
                {
